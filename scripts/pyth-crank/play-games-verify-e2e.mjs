...
const recompute = {
  ...
  pump: (seed, cs, n, p, w) => { const bustAt = 1 + Math.floor(f0(seed, cs, n) * 9); const survived = p.pumps < bustAt; const m = Math.round((0.99 / ((9 - p.pumps) / 9)) * 1e9) / 1e9; return survived ? w * m : 0; },
