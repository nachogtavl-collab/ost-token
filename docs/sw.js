const CACHE_NAME = 'ost-pwa-cache-v432';
...
const PRECACHE_PATHS = [
  ...
  './app.js?v=261',
  './ost-predict-mobile.js?v=27',
  './ost-predict-mobile.css?v=8',
  ...
  './mesh/mesh.css?v=14',
  './compartments.js?v=7',
  './prediction-extras.js?v=19',
  './ost-positions.js?v=2',
  './prediction-pro.js?v=214',
