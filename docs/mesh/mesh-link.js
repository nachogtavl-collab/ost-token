...
(function () {
  ...
  var TARGETS = {
    ...
    // Casual games (non-staked)
    'games':        function () { if (window.OST_MESH_GAMES && window.OST_MESH_GAMES.open) { window.OST_MESH_GAMES.open(); return true; } return openArena(); },
    'casual-games': function () { if (window.OST_MESH_GAMES && window.OST_MESH_GAMES.open) { window.OST_MESH_GAMES.open(); return true; } return openArena(); },
    'mesh-games':   function () { if (window.OST_MESH_GAMES && window.OST_MESH_GAMES.open) { window.OST_MESH_GAMES.open(); return true; } return openArena(); },
    'chess':        function () { if (window.OST_MESH_GAMES && window.OST_MESH_GAMES.open) { window.OST_MESH_GAMES.open('chess'); return true; } return openArena(); },
    'pool':         function () { if (window.OST_MESH_GAMES && window.OST_MESH_GAMES.open) { window.OST_MESH_GAMES.open('pool8'); return true; } return openArena(); },
    'pool8':        function () { if (window.OST_MESH_GAMES && window.OST_MESH_GAMES.open) { window.OST_MESH_GAMES.open('pool8'); return true; } return openArena(); },
    'cuppong':      function () { if (window.OST_MESH_GAMES && window.OST_MESH_GAMES.open) { window.OST_MESH_GAMES.open('cuppong'); return true; } return openArena(); },
    'tictactoe':    function () { if (window.OST_MESH_GAMES && window.OST_MESH_GAMES.open) { window.OST_MESH_GAMES.open('tictactoe'); return true; } return openArena(); },
    'minigolf':     function () { if (window.OST_MESH_GAMES && window.OST_MESH_GAMES.open) { window.OST_MESH_GAMES.open('minigolf'); return true; } return openArena(); },
    // Ghost
