...
(function () {
  ...
  function injectStyle() {
    ...
    style.textContent = [
      ...
      '.omu-actions{display:flex;gap:6px;flex-wrap:wrap}.omu-actions button,.omu-contact button,.omu-snippet{border:1px solid rgba(255,255,255,.12);border-radius:10px;background:rgba(255,255,255,.07);color:#e8fbff;padding:8px 9px;font-weight:750;font-size:12px;cursor:pointer}.omu-actions button.primary{background:linear-gradient(135deg,#00d4ff,#00ff9f);border-color:transparent;color:#03131c}',
      ...
      '.omu-snippets{display:flex;gap:6px;flex-wrap:wrap}.omu-snippet{max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}',
