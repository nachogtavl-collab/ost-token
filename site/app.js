...
(function () {
  ...
  const translations = {
    en: {
      ...
      'features.f4.title': 'DAO Treasury', 'features.f4.text': '0.1% fee funds satellite infrastructure. Voted on-chain by stakers.',
    ...
    es: {
      ...
      'features.f4.title': 'Tesoro DAO', 'features.f4.text': '0.1% de comision financia infraestructura satelital. Votacion on-chain por stakers.',
    ...
    zh: {
      ...
      'features.f4.title': 'DAO国库', 'features.f4.text': '0.1%费用资助卫星基础设施。由质押者链上投票。',
    ...
    ru: {
      ...
      'features.f4.title': 'Казна DAO', 'features.f4.text': '0.1% комиссии финансирует спутники. Голосование на блокчейне.',
    ...
    hi: {
      ...
      'features.f4.title': 'DAO खजाना', 'features.f4.text': '0.1% शुल्क उपग्रह बुनियादी ढांचे को निधि देता है। स्टेकर्स द्वारा ऑन-चेन वोटिंग।',
    ...
    ar: {
      ...
      'features.f4.title': 'خزينة DAO', 'features.f4.text': '0.1% رسوم تمول الأقمار الصناعية. تصويت على البلوكتشين.',
    ...
    pt: {
      ...
      'features.f4.title': 'Tesouro DAO', 'features.f4.text': '0.1% de taxa financia satelites. Votacao on-chain por stakers.',
    ...
    fr: {
      ...
      'features.f4.title': 'Tresor DAO', 'features.f4.text': '0.1% de frais finance les satellites. Vote on-chain par les stakers.',
    ...
    ja: {
      ...
      'features.f4.title': 'DAOトレジャリー', 'features.f4.text': '0.1%の手数料が衛星インフラに。ステーカーによるオンチェーン投票。',
    ...
    ko: {
      ...
      'features.f4.title': 'DAO 재무', 'features.f4.text': '0.1% 수수료가 위성 인프라를 자금 지원합니다. 스테이커의 온체인 투표.',
    ...
    tr: {
      ...
      'features.f4.title': 'DAO Hazinesi', 'features.f4.text': '%0.1 ucret uydu altyapisini finanse eder. Stake edenler tarafindan zincir uzerinde oylama.',
