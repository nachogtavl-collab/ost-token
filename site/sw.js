const CACHE_NAME = 'ost-pwa-cache-v163';
const RUNTIME_CACHE = 'ost-pwa-runtime-v163';
...
const PRECACHE_PATHS = [
  ...
  './prediction-pro.js?v=31',
  './prediction-scalar.js?v=3',
  './prediction-modal.js?v=45',
  './prediction-trade-popout.js?v=4',
  ...
  './apple-tap.js?v=3',
  './ost-card.js?v=7',
  './launchpad-engine.js?v=3',
  './swap-resilient.js?v=3',
  './ost-games.js?v=19',
  './code-academy.js?v=3',
  './i18n-runtime.js?v=4',
  './devnet-rescue.js?v=9',
