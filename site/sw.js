const CACHE_NAME = 'ost-pwa-cache-v160';
const RUNTIME_CACHE = 'ost-pwa-runtime-v160';
...
const PRECACHE_PATHS = [
  ...
  './prediction-pro.js?v=29',
  './prediction-scalar.js?v=3',
  './prediction-modal.js?v=43',
