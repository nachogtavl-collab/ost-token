const CACHE_NAME = 'ost-pwa-cache-v65';
const RUNTIME_CACHE = 'ost-pwa-runtime-v65';
...
const PRECACHE_PATHS = [
  ...
  './mesh/mesh.js?v=23',
  './mesh/veil.js?v=1',
  './mesh/mesh-play.js?v=5',
  './mesh/mesh-upgrade.js?v=6',
  ...
  './prediction-trade-popout.js?v=2',
