const CACHE_NAME = 'ost-pwa-cache-v133';
const RUNTIME_CACHE = 'ost-pwa-runtime-v117';
...
const PRECACHE_PATHS = [
  ...
  './mesh/mesh.css?v=14',
  './compartments.js?v=4',
  './prediction-extras.js?v=9',
  './prediction-pro.js?v=13',
  './prediction-scalar.js?v=3',
  './prediction-modal.js?v=26',
  './prediction-trade-popout.js?v=3',
  './prediction-pro-dash.js?v=9',
  './ost-console.js?v=2',
